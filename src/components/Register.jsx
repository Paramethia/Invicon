            ...
            <div className="w-full md:w-1/2 flex flex-col items-center justify-center bg-gray-400">
                ...
                <div className="bg-gray-300 p-8 rounded shadow-md w-3/4 animate__animated animate__fadeInRight">
                        ...
                        <form onSubmit={handleRegister}>
                            ...
                            <button type="submit" disabled={loading} className="w-full bg-dark text-white py-2 rounded-md transition duration-300 ease-in-out transform hover:scale-105">  { loading ? <center><div className="dots-loader"></div></center> : "Register"} </button>
                        </form>
